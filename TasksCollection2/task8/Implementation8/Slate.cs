...
{
    public class Slate : IConstructionMachinery
    {
        ...
        public Slate(Coordinates baseCoordinates, Coordinates nextCoordinates)
        {
        ...
        public void Run()
        {
            while (true)
            {
                ...
                else
                {
                    ...
                    Coordinates coordinates = new Coordinates(house.Coordinates.X, house.Coordinates.Y + 195, house.Coordinates.Step);
