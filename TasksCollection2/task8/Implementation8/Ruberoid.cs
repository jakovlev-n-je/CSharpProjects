...
{
    public class Ruberoid : IConstructionMachinery
    {
        ...
        public Ruberoid(Coordinates baseCoordinates, Coordinates nextCoordinates)
        {
        ...
        {
            Thread.Sleep(1500);
            house.RoofType = typeof(Ruberoid);
        ...
        public void Run()
        {
            while (true)
            {
                ...
                else
                {
                    ...
                    Coordinates coordinates = new Coordinates(house.Coordinates.X, house.Coordinates.Y + 155, house.Coordinates.Step);
