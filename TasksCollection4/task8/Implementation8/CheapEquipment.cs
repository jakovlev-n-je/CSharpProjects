...
{
    public class CheapEquipment : IEquipment
    {
        ...
        public CheapEquipment(Coordinates baseCoordinates, Coordinates nextCoordinates)
        {
        ...
        {
            Thread.Sleep(1000);
            factory.EquipmenType = typeof(CheapEquipment);
