...
{
    public class AmateurEquipment : IEquipment
    {
        ...
        public AmateurEquipment(Coordinates baseCoordinates, Coordinates nextCoordinates)
        {
        ...
        {
            Thread.Sleep(1000);
            factory.EquipmenType = typeof(AmateurEquipment);
